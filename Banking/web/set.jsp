            ...
            <div class="container">
                <div class="row">
                    <div class="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8 col-md-12 col-sm-12">
                            <!--- *****  Content here  ***** -->     
                            <div class="d3">
                <form  action="setcode.jsp">
                <table width="344">
                        <br/>
                    <tr><td width="168">Account id : </td><td width="164"><%=session.getAttribute("ID") %></td></tr><tr></tr>
                    <tr><td>Password</td><td><input type="password" placeholder="enter amount to deposit" name="pass" autocomplete="off"></td></tr>
                    <tr><td>Enter new UPI Pin</td></tr>
                    <tr><td><input type="password" placeholder="enter four digit pin" name="pin"></td></tr>
                </table>
                <br>
